window.myExtCode.parserBefore();
	...
	// 调整子窗口大小
eform("edoc2ListGrid_myInbox").method("extendHeadOperate",function(extendButton){
	
	if(eform.pageType == "pc"){
		if(extendButton.opt.operateType=="custom" && extendButton.opt.formId =="181116135227"){
			extendButton.opt.openWindowWidth = "480";
			extendButton.opt.openWindowHeight = "270";
		}
