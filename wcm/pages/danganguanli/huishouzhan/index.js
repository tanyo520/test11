...
require(["jquery","inbizsdk"],function($,inbizsdk){
	...
	//左侧树
	var leftObj =inbiz("IFrame352bca5f3f4f4691b613fa21d8eeaf12");
	leftObj.afterEvent=function(){
		...
		var leftSrc = "/eform/index?formid="+formId+"&skin=techblue&archState=4";
	...
	topObj.afterEvent=function(){
		...
		//右边内容区
	var rightObjt =inbiz("IFramee405824df85f45979989b8a78c4621da");
