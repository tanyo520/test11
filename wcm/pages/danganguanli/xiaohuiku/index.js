...
require(["jquery","inbizsdk"],function($,inbizsdk){
	...
	//左侧树
	var leftObj =inbiz("IFrame819a3148d6374104801f4a7cba0a23f5");
	leftObj.afterEvent=function(){
		...
		var leftSrc = "/eform/index?formid="+formId+"&skin=techblue&archState=3";
	...
	topObj.afterEvent=function(){
		...
		//右边内容区
	var rightObjt =inbiz("IFrame961a681528124ab78243d265597f2207");
