define(["knockout", "jquery", "inbizsdk"], function (ko, $, inbizsdk) {
    ...
    inbizsdk.$dataset("Selectarchtype", {Id: archtypeid}, function (data) {
        ...
        archFormId = data.Data[0][0].archPropFormId;
                                ...
                                $.each(e.data.MetaAttrList, function (index, item) {
                                    if (item.ControlModel.ControlType != "edoc2Hidden") {
                                        ...
                                        tdtr = ' <tr style="height: 50px;">\n' +
                                            '                <td style="width: 145px;">' + item.ControlModel.Name + '&nbsp; : </td>\n' +
                    ...
                    inbizsdk.$dataset("selectFilesByArchId", {archId: id}, function (result) {
                        ...
                        if (files.length > 0) {
                            for (var i = 0; i < files.length; i++) {
                                ...
                                var imgHTML = '<ul style="height: 43px;"><img style="height: 20px;width: 20px;margin-right: 10px;" src="/external/icon-file-type/32/' + fileFormat + '.png"><a  target=view_window href="/preview.html?fileid='+fileId+'">' + fileName + '</a></ul>';
